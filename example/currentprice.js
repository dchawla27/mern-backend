...
function identifyBullishThreeLineStrike(candles) {
  ...
  if (firstThreeBullish && fourthBearishEngulfing) {
    console.log("Bullish Three Line Strike pattern identified. Buy at 10:04.");
  } else {
    // console.log("No Bullish Three Line Strike pattern detected.");
  }
}
...
function identifyBearishThreeLineStrike(candles) {
  ...
  if (firstThreeBearish && fourthBullishEngulfing) {
    console.log("Bearish Three Line Strike pattern identified. Sell at 10:04.");
  } else {
    // console.log("No Bearish Three Line Strike pattern detected.");
  }
}
