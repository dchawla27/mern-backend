        ...
        if(ind !== 0){  
          ...
          if(lastCandle[4] > lastCandle[1]){
            if(currentCandle[1] > lastCandle[4] && currentCandle[1] > lastCandle[1]){
              ...
              if(currentCandle[1] > lastCandle[4]){
                ...
                if(thirtyPoints > 10){
                  ...
                  tradesWithProfit++
                  totalCallPoints += 10
                  console.log("SUCCESS -> Green Candle",currentCandle[0], openingDiff.toFixed(2), points.toFixed(2))
                }else{
                  totalTrades++
                  tradesWithLoss++
                  totalCallPoints += points
                  console.log("FAILUER -> Green Candle",currentCandle[0], openingDiff.toFixed(2), points.toFixed(2))
                }
                // let points = currentCandle[4]-currentCandle[1]
                // let thirtyPoints = currentCandle[2]-currentCandle[1]
            ...
            if(lastCandle[4] > currentCandle[1]  && lastCandle[1] > currentCandle[1]){
              ...
              // if(openingDiff >= threshold){
              if(lastCandle[4] > currentCandle[1]){
                ...
                if(thirtyPoints > 10 ){
                  ...
                  totalPutPoints += 10
                  tradesWithProfit++
                  console.log("SUCCESS -> Red Candle",currentCandle[0], openingDiff.toFixed(2), points.toFixed(2))
                }else{
                  totalTrades++
                  tradesWithLoss++
